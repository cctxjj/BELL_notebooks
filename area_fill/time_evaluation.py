...
vis.plot_runtime_comparison(["stack-based recursive flood fill", "queue-based recursive flood fill", "stack-based scanline flood fill", "queue-based scanline flood fill", "stack-based scanline flood fill (optimized)"], [stack_recursive_datapoints, queue_recursive_datapoints, stack_scanline_datapoints, queue_scanline_datapoints, stack_scanline_opt_datapoints], ["#4A0072", "#E91E63", "#9C27B0", "#F06292", "#E1BEE7"], title="Vergleich Zeitkomplexität aller Flood Fill Varianten", save_path=data_save_path+"run_" + run + "/", file_name="graph_comparison_overall.png")
...
vis.plot_runtime_comparison(["queue-based recursive flood fill", "queue-based scanline flood fill"], [queue_recursive_datapoints, queue_scanline_datapoints], ["#E91E63", "#F06292"], title="Vergleich Zeitkomplexität für alle queue-based Varianten", save_path=data_save_path+"run_" + run + "/", file_name="graph_comparison_queue_based.png")
